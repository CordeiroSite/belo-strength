        ...
        <div className="grid lg:grid-cols-2 gap-10 items-stretch">
          <div className="flex flex-col">
            ...
            <h2 className="font-display font-extrabold text-foreground text-4xl md:text-6xl mt-3 leading-[0.95]">
              VENHA NOS <br />
              <span className="text-secondary">VISITAR.</span>
            </h2>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="mt-8 inline-flex items-center justify-center gap-3 px-7 py-5 bg-primary text-primary-foreground font-display font-extrabold uppercase tracking-wider text-sm hover:bg-secondary hover:text-white transition-all"
            >
          ...
          <div className="relative overflow-hidden border-4 border-dark min-h-[420px] lg:min-h-full">
            <iframe
...
function Info({
  ...
  return (
    <div className="flex items-start gap-4 p-5 bg-muted hover:bg-dark hover:text-white group transition-colors">
      <div className="w-11 h-11 bg-primary flex items-center justify-center shrink-0">
        <Icon className="w-5 h-5 text-primary-foreground" strokeWidth={2.4} />
      </div>
      <div>
        <div className="font-display font-extrabold uppercase text-xs tracking-wider text-muted-foreground group-hover:text-primary">
          {title}
        </div>
